            ...
            <View style={{
              ...
              <View style = {{
                    flex : 6,
                         ...
                         <View style ={{margin : 30}}> 
                             ...
                             <View style ={{ paddingTop: 15 ,alignItems: 'flex-end',}}><TouchableOpacity onPress={onClickForgetPass}><Text>Forgotten password?</Text></TouchableOpacity></View>
                         </View>
              ...
              <View style ={{
                      ...
                      alignItems : 'center'
                         ...
                         <TouchableOpacity style ={{padding :20}}><Text style ={{color : 'black',fontWeight : '500'}} onPress={onClickSingup}>Sign Up</Text></TouchableOpacity>
              </View>
            </View>
          </View>
        </View>
