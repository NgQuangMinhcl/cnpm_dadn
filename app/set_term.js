...
import Auto_tem_modal from "./components/auto_tem_modal";
...
const Set_term = () => {
  ...
  const turnoff = async () => {
    const URL = "https://auth-nodejs.fly.dev/api/auto/fanon";
    const data = {
      temp: -99,
    };
    try {
          ...
          >
            <View style={{ marginTop: 20, marginLeft: 10, marginRight: 10 }}>
              <Text style={{ fontSize: 15 }}>
                You can set the temperature you want to keep your room at. We
                will automatically turn on the air conditioner when the
                temperature exceeds the temperature you set.
              </Text>
              <View
                style={{
                  marginTop: 20,
              ...
              <Text style={{ fontSize: 15, marginTop: 20 }}>
                You can set the temperature you want to keep your room at. We
                will automatically turn off the air conditioner when the
                temperature exceeds the temperature you set.
              </Text>
              <View
                style={{
