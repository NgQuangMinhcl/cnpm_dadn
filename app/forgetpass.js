              ...
              <View style = {{
                    flex : 6,
                         ...
                         <View><Text style ={{color : 'black'}}>Name</Text></View>
                             ...
                             <View style ={{ paddingTop: 5 ,marginLeft : 30, marginRight : 25, borderBottomColor :'Gray', borderBottomWidth :1}}><TextInput secureTextEntry={true} placeholder={'Type your new password'} value={password} onChangeText={onchangePassword}/></View>
                         </View>
    
                         <View>
                            <TouchableOpacity style ={{height:50,borderRadius: 50,marginLeft : 90, marginRight : 90,justifyContent : 'center',alignItems : 'center', marginVertical: 20,backgroundColor : "#00A7EB"}} onPress = {onclick}><Text>Change</Text></TouchableOpacity>
                         </View>
              </View>
              {/*end*/}
            </View>
...
export default ForgetPassSrceen