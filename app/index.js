...
import Light_screen from "./screen_final.js/light_screen";
import Humid_screen from "./screen_final.js/humid_screen";
import History from "./history";
import View_history from "./control_history";
import Login_history from "./login_history";
import Door_screen from "./screen_final.js/door_screen";
  ...
  return (
    <NavigationContainer independent={true}>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="light_screen" component={Light_screen} />
        <Stack.Screen name="humid_screen" component={Humid_screen} />
        <Stack.Screen name="view_history" component={View_history} />
        <Stack.Screen name="history" component={History} />
        <Stack.Screen name="login_history" component={Login_history} />
        <Stack.Screen name="door" component={Door_screen} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
