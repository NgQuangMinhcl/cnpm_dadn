...
const Auto_tem_modal = ({ visible, onHide, tempOn, tempOff }) => {
  ...
  const sendtempOff = async () => {
    const URL = "https://auth-nodejs.fly.dev/api/auto/fanoff";
    const data = {
      temp: tempOff,
    };
    try {
        ...
        <View style={styles.noti}>
          ...
          <View>
            <View style={{ justifyContent: "center", alignItems: "center" }}>
              <Text>Nhiệt độ bật quạt: {tempOn}°C</Text>
              <Text>Nhiệt độ tắt quạt: {tempOff}°C</Text>
              <Text>
