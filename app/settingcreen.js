...
const Settingscreen = () => {
  ...
  const OnNeedHelp_click = () => {
    setshowmodal(true);
    setErrormessage(
      "Đối với mọi thắc mắc, hay yêu cầu trợ giúp nào, vui lòng liên hệ trực tiếp với chúng tôi thông qua địa chỉ: minh.nguyenquang@hcmut.edu.vn"
    );
  };
  ...
  return (
    <View>
      <Set_ava_modal
        visible={showmodal_image}
        message={image_mes}
        onHide={onHide_image}
      />
      <Set_name_modal
        visible={showmodal_name}
        message={username_mes}
        onHide={onHide_name_modal}
      />
      <Loginmodal
        visible={showmodal}
      ...
      <View style={{ flexDirection: "row", marginTop: 40 }}>
        ...
        <Text style={{ fontSize: 20, marginLeft: 150, fontWeight: "bold" }}>
          Setting
        </Text>
      </View>
      <View
      ...
      >
        ...
        >
          ...
          <Text style={{ marginTop: 20, marginLeft: 20 }}>Auto control :</Text>
          <View style={{ alignItems: "center" }}>
            <TouchableOpacity
              style={{
                marginTop: 20,
            ...
            >
              <Ionicons
                ...
                style={{ marginLeft: 10 }}
              />
              <Text style={{ fontSize: 15 }}> Auto check</Text>
            </TouchableOpacity>
          </View>
          <Text style={{ marginTop: 20, marginLeft: 20 }}>
